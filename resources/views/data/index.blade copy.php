                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col text-center">
                                                ...
                                                <p class="card-text mb-0" style="cursor: context-menu"  
                                                    data-toggle="popover" data-placement="bottom" title="Gender" data-content="  Male: {{ $singleYear['total_infected_gender']['male'] }} | Female: {{ $singleYear['total_infected_gender']['female'] }}">
                                                    Infected
                                                </p>
                                            ...
                                            <div class="col text-center">
                                                ...
                                                <p class="card-text mb-0 text-danger" style="cursor: context-menu"     
                                                    data-toggle="popover" data-placement="bottom" title="Gender" data-content="  Male: {{ $singleYear['total_death_gender']['male'] }} | Female: {{ $singleYear['total_death_gender']['female'] }}">
                                                    Deaths
                                                </p>
