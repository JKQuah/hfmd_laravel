...
;(function(factory) {
    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            // CURRENT
            _.$current = {
                month: (isNaN(this.month) || this.month == null) ? new Date(year, 0, 1, 0, 0, 0, 0).getMonth() : this.month,
                year: (isNaN(this.year) || this.year == null) ? new Date(year, 0, 1, 0, 0, 0, 0).getFullYear() : this.year,
                date: _.formatDate(_.initials.dates[_.defaults.language].months[new Date(year, 0, 1, 0, 0, 0, 0).getMonth()]+' '+new Date(year, 0, 1, 0, 0, 0, 0).getDate()+' '+ new Date(year, 0, 1, 0, 0, 0, 0).getFullYear(), _.options.format)
            }
